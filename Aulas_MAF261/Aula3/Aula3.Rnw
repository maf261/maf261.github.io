...
#-----------------------------------------------
setwd("E:/Documentos/GitHub/MAF261/maf261.github.io/Aulas_MAF261/Aula3")
library(readr)
...
\begin{block}{}
\justifying
Dado $Z\sim N(0,1),$ calcule $P(Z\leq 0)$
\end{block}
\begin{center}
...
\begin{minipage}{0.1\linewidth}
  ...
  axis y line*=left,
  y axis line style={draw opacity=0},
  axis x line=left, xlabel={$P(Z\leq 0.32)=0.6255$}, %ylabel=Densidade de Probabilidade,
  %every axis y label/.style={at=(current axis.above origin),anchor=south},
  %%every axis x label/.style={at=(current axis.right of origin),anchor=west},
  height=8cm, width=10cm,
  ticks=both,
